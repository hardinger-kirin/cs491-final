defmodule FinalWeb.EmployeeControllerTest do
  use FinalWeb.ConnCase

  import Final.HumanResourcesFixtures

  @create_attrs %{department: "some department", first_name: "some first_name", hire_date: ~D[2023-04-24], id_number: 42, last_name: "some last_name"}
