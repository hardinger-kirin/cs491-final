defmodule SmsWeb.ProductLiveTest do
  ...
  @create_attrs %{inventory: 42, name: "some name", retail: 120.5, vendor: "some vendor", wholesale: 120.5}
  @update_attrs %{inventory: 43, name: "some updated name", retail: 456.7, vendor: "some updated vendor", wholesale: 456.7}
  @invalid_attrs %{inventory: nil, name: nil, retail: nil, vendor: nil, wholesale: nil}
